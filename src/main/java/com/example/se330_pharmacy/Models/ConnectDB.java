...
public class ConnectDB {
    ...
    public PreparedStatement getPreparedStatement(String sqlQuery) throws SQLException {
        return databaseLink.prepareStatement(sqlQuery);
    }

    public PreparedStatement getPreparedStatement(String sqlQuery, int autoGeneratedKeys) throws SQLException {
        return databaseLink.prepareStatement(sqlQuery, autoGeneratedKeys);
    }
}
